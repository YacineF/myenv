...
#plugins=(colored-man-pages command-not-found packages docker git npm pep8 pip pyenv python sudo systemd ubuntu zsh_reload zsh-autosuggestions zsh-syntax-highlighting)
#plugins=(git dogesay zsh-autosuggestions)
